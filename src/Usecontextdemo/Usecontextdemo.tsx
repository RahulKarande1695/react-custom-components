    ...
    <div className="demo__section">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
        ...
        <div>
          ...
          <div className="tree">
            ...
            <div className="tree__node tree__node--mid-bad">
              Layout (user) 👎
            </div>
            <div className="tree__node tree__node--mid-bad">
              Sidebar (user) 👎
        ...
        <div>
          ...
          <div className="tree">
            ...
            <div className="tree__node tree__node--leaf">
              Avatar (consumer) ✓
            </div>
          </div>
        </div>
      ...
      <div className="compare">
        ...
        <div className="compare__cell compare__cell--bad">
          Middle components get unnecessary props
        </div>
        <div className="compare__cell compare__cell--good">
          Middle components stay clean
        </div>
        <div className="compare__cell compare__cell--bad">
          Refactor pain when prop added/removed
        </div>
        <div className="compare__cell compare__cell--good">
          One place to update
        </div>
      ...
      <p className="demo__note">
        Context is often unnecessary when data only needs to be passed down one
        or two component levels. In such cases, passing props is usually simpler
        and more maintainable. However, when data must be shared across three or
        more levels, or for application-wide state such as themes,
        authentication, or localization, React Context is a more appropriate
        solution.
      </p>
    </div>
  );
    ...
    <ThemeContext.Provider value={{ mode, tokens, setMode }}>
      <div className="demo__section">
        ...
        <p className="demo__title">
          Theme context — global tokens without prop drilling
        </p>
  ...
  return (
    <div className="auth-card">
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <span className={`auth-card__role ${roleColors[user.role]}`}>
          {user.role}
        </span>
        <button
  ...
  return (
    ...
    >
      <div className="demo__section">
        ...
        <p className="demo__note">
          <code>useAuth()</code> is a custom context hook that includes a guard
          to ensure it is used only within the appropriate provider.{" "}
          <code>RoleGate</code> checks whether the current user's role exists in
          the <code>allowed</code> roles array by reading the user from the
          authentication context. This is a common pattern in real-world React
          applications and is often combined with React Router{" "}
          <code>loader</code>s to enforce authentication and role-based
          authorization before rendering a route.
        </p>
      </div>
    </AuthContext.Provider>
  );
